...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Fancy success alert with timeout
      const successAlert = document.createElement("div");
      successAlert.className =
        "fixed top-4 right-4 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded shadow-lg z-50 transition-all duration-300 transform translate-x-0 opacity-100";
      successAlert.innerHTML = `
        <div class="flex items-center">
          ...
          <span class="ml-2">Login successful. Redirecting...</span>
        </div>
      `;
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 outline-none"
                    placeholder="••••••••"
                    required
                  />
                  <button
